...
#define SCENE_MODEL_UNIFORM_LOCATION 0
#define SCENE_VIEW_UNIFORM_LOCATION 1
#define SCENE_PROJ_UNIFORM_LOCATION 2
#define SCENE_MVP_UNIFORM_LOCATION 3
#define SCENE_CAMERAPOS_UNIFORM_LOCATION 4
